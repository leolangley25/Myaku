...
const MYAKU_LOG_CONFIGS = {
  caffeine: {
    ...
    labelPlaceholder: "e.g. Coffee, Energy Drink, Tea",
    amountField: "Caffeine (mg)",
    amountPlaceholder: "e.g. 95",
  ...
  hydration: {
    labelField: "Source",
    labelPlaceholder: "e.g. Water, Sports Drink",
    amountField: "Amount (oz)",
    amountPlaceholder: "e.g. 16",
  ...
  screen_time: {
    labelField: "Activity",
    labelPlaceholder: "e.g. Phone, Laptop, TV",
    amountField: "Minutes",
