...
(function () {
  const icons = {
    ...
    pvt:
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="13.5" r="7.5"/><path d="M12 9.5v4l2.5 1.5"/><path d="M9.5 2.5h5"/></svg>',
    share:
  ...
  const links = [
    ...
    { id: "pvt", href: "pvt.html", label: "Vigilance", icon: icons.pvt },
